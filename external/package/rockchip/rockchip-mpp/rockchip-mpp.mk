...
ROCKCHIP_MPP_VERSION = $(subst /,-,$(BR2_PACKAGE_ROCKCHIP_SDK_VERSION))
ROCKCHIP_MPP_SITE = $(call gitlab,firefly-linux,external/mpp,$(BR2_PACKAGE_ROCKCHIP_SDK_VERSION))
ROCKCHIP_MPP_SOURCE = mpp-$(ROCKCHIP_MPP_VERSION).tar.bz2
