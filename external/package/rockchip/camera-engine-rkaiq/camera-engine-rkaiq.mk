...
CAMERA_ENGINE_RKAIQ_VERSION = $(subst /,-,$(BR2_PACKAGE_ROCKCHIP_SDK_VERSION))
CAMERA_ENGINE_RKAIQ_SITE = $(call gitlab,firefly-linux,external/camera_engine_rkaiq,$(BR2_PACKAGE_ROCKCHIP_SDK_VERSION))
CAMERA_ENGINE_RKAIQ_SOURCE = camera_engine_rkaiq-$(CAMERA_ENGINE_RKAIQ_VERSION).tar.bz2
...
CAMERA_ENGINE_RKAIQ_DEPENDENCIES = host-vim
...
ifeq ($(BR2_GCC_VERSION_14_X), y)
CAMERA_ENGINE_RKAIQ_CONF_OPTS += -DCMAKE_CXX_FLAGS=-Wno-error=template-id-cdtor
endif
